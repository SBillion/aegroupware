...
(function($){
  ...
  $._timePicker = function(elm, settings) {
    ...
    $tpDiv.append($tpList);
    // Append the timPicker to the body
    ...
    var showPicker = function() {
      ...
      // Set timePicker width
      $tpDiv.css('min-width', $(elm).innerWidth());
      
      // Set picker position
      var elmOffset = $(elm).offset();
      elmOffset.top += $(elm).outerHeight();
      $tpDiv.css({'top':elmOffset.top, 'left':elmOffset.left});
	  //$tpDiv.position({ my: "left bottom", at: "left top", of: elm });
